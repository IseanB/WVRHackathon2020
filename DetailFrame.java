...
public class DetailFrame implements ActionListener{ //implements ActionListener{
	...
	public DetailFrame(JFrame a, int b) throws IOException{
		...
		def.setFont(new java.awt.Font("TimesRoman",Font.PLAIN, 12));
		def.setForeground(Color.WHITE);
		def.setBounds(500, 50, 852, 461);
		
		tar.setFont(new java.awt.Font("TimesRoman",Font.PLAIN, 12));
		tar.setForeground(Color.WHITE);
		tar.setBounds(500, 100, 852, 461);
		
		avg.setFont(new java.awt.Font("TimesRoman",Font.PLAIN, 12));
		avg.setForeground(Color.WHITE);
		avg.setBounds(500, 150, 852, 461);
		
		opr.setFont(new java.awt.Font("TimesRoman",Font.PLAIN, 12));
		opr.setForeground(Color.WHITE);
		opr.setBounds(500, 200, 852, 461);
		
		blank.setFont(new java.awt.Font("TimesRoman", Font.PLAIN, 12));
		blank.setForeground(customColor);
		blank.setBounds(500, 250, 852, 461);
